...
MODELSPATH = r'C:/Users/15199/Desktop/semester4/capstone final/traffic_sign/model'
Datapath= r'C:/Users/15199/Desktop/semester4/capstone final/traffic_sign'

@st.cache(allow_output_mutation=True)
def get_model():
        model = load_model('C:/Users/15199/Desktop/semester4/capstone final/traffic_sign/model/TSC_model2.h5')
        print('Model Loaded')
        return model 
...
def load_models():
    ...
    model = load_model(MODELSPATH + '/TSC_model2.h5')
    return model
...
def main():
    st.sidebar.header('Traffic sign recognisation')
    st.sidebar.subheader('Choose a page to proceed:')
    page = st.sidebar.selectbox("", ["Sample Data", "Upload Your Image"])

    if page == "Sample Data":
        st.header("Traffic Sign Recognisation")
        st.markdown("""
